...
use aveline_core::attention::{Attention, AttentionConfig};
use aveline_core::knowledge::Document;

use aveline_core::character;
use aveline_core::init_logging;
use aveline_core::knowledge::KnowledgeBase;
use aveline_core::loaders::github::GitLoader;
use aveline_core::{agent::Agent, clients::discord::DiscordClient, clients::twitter::TwitterClient, clients::telegram::TelegramClient};
...
struct Args {
    ...
    #[arg(long, default_value = "aveline/src/characters/aveline.toml")]
    character: String,
